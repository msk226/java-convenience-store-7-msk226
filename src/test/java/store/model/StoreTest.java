...
//    public void setUp() {
//        // Promotion 설정
//        promotion = new Promotion("2+1", 2, 1, LocalDate.of(2024, 11, 1), LocalDate.of(2024, 11, 30));
//
//        // Product 설정
...
//
//        // Order 설정
//        order1 = new Order("Product A", 3); // 2+1 프로모션 적용
//        order2 = new Order("Product B", 2); // 프로모션 없음
//
//        // Store 설정
...
//        Order order = new Order("TEST", 100);;
...
//        Order order = new Order("Product A", 100);;
//        assertThrows(IllegalArgumentException.class,
//                () ->  store.processOrder(new ArrayList<>(List.of(order))));
//    }
//
...
//        int expectedTotalAmount = 700;
//        assertEquals(expectedTotalAmount, totalAmount);
//    }
//
//    @Test
//    public void 총_할인_금액_테스트() {
//        int discountAmount = store.calculateDiscountAmount(List.of(order1, order2), LocalDate.now());
//        int expectedDiscountAmount = 100;
//        assertEquals(expectedDiscountAmount, discountAmount);
//    }
//
//    @Test
//    public void 최종_결제_금액_테스트() {
//        int finalAmount = store.calculateFinalAmount(List.of(order1, order2), LocalDate.now());
//        int expectedFinalAmount = 600;
